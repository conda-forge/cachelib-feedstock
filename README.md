...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/cachelib-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10835&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/cachelib-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `cachelib` can be installed with:

```
conda install cachelib
```

It is possible to list all of the versions of `cachelib` available on your platform with:
